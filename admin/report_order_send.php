                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4 mt-4">
                            ...
                            <br>
                                ...
                                <a href="report_order_send.php"><button type="button" class="btn btn-secondary">ส่งสินค้าเรียบร้อย</button></a>
                                <a href="report_order_no.php"><button type="button" class="btn btn-outline-danger">ยกเลิกการสั่งซื้อ</button> </a>

                            <br><br>

                                <i class="fas fa-table me-1"></i>
                                แสดงข้อมูลการสั่งซื้อสินค้า (ส่งสินค้าเรียบร้อย)
                                <div>
...
?>
                                        <tr>
                                            ...
                                            if($status == 1){
                                                ...
                                                echo "<b style='color:red'> ส่งสินค้าเรียบร้อย </b>";
                                            }
                                                ?>
