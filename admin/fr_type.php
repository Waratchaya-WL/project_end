...
<input type="number" name="typeID" class="form-control" placeholder="รหัสประเภทสินค้า..." required > <br>
<label>ชื่อประเภทสินค้า :</label> 
<input type="text" name="type_name" class="form-control" placeholder="ชื่อประเภทสินค้า..." required > <br>
